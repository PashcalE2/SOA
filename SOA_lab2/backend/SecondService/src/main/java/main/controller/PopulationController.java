...
public class PopulationController {
    ...
    public ResponseEntity<?> countPopulation(@PathVariable Long id1, @PathVariable Long id2, @PathVariable Long id3) {
    ...
    public ResponseEntity<?> moveToPoorest(@PathVariable Long cityId) {
